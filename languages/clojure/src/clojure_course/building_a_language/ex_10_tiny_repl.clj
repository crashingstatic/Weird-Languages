...
;; === YOUR TASK ===
;; Implement run-program: evaluate a sequence of program lines (strings)
;; in order, sharing a single environment. Returns a vector of results.

(defn run-program [lines]
